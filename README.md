...
### [Cтруктуроване пояснення коду, орієнтоване на навчання учнів (HTML/CSS, робота з псевдоелементами та hover-ефектами).] (https://github.com/KvitkaLi/Menu_underline/commit/07c2b2481ed3cb15f99da386abd852a6a43f9a83)
